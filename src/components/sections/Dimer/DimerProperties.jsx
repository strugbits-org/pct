  ...
  return (
    <section className="bg-white pt-[72px]">
      <FullWidthContent className="text-center mb-6">
        ...
        <div className="grid grid-rows-3 grid-cols-1 md:grid-rows-1 md:grid-cols-3 max-w-[300px] md:max-w-[1300px] justify-between mx-auto gap-[52px]">
          ...
          <PCTDimerCard className="md:pt-12" src={"/images/icons/setting.svg"} title={"Purity"} detail={"PCT'S dimer is more than 99.9% pure. The purest available on the market."}/>
          <PCTDimerCard src={"/images/icons/setting.svg"} title={"Competitive Price"} detail={"Great quality product, made affordable for you. "}/>
        </div>
      </FullWidthContent>
      <div className="pt-28 pb-16 bg-clip-path-1 text-secondary bg-[url('/images/bg_our_achievements.jpg')] bg-no-repeat bg-cover bg-bottom">
        <FullWidthContent className="flex items-center justify-between flex-col md:flex-row gap-x-44">
