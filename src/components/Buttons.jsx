  ...
  return (
    <button
      className={cn(
        ...
        "before:absolute before:rounded-full before:w-[5px] before:h-[5px] before:-bottom-[20px] before:left-[50%] before:transition-all before:duration-700 before:-z-[1] before:-translate-x-[50%]",
